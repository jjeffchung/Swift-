...
class StoryNodeViewController: UIViewController {
    override func viewDidLoad() {
        ...
        self.navigationItem.rightBarButtonItem = UIBarButtonItem(title: "Start Over", style: UIBarButtonItem.Style.plain, target: self, action: #selector(StoryNodeViewController.startOver))
